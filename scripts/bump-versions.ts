 ...
 *
 * Only updates the `version` field. All `@kanjijs/*` inter-package
 * references stay as `workspace:*` — pnpm converts them automatically
 * to the concrete version at publish time.
 *
 * Usage:
